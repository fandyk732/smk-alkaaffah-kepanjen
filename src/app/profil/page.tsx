        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          ...
          <Reveal>
            <div className="overflow-hidden rounded-3xl border shadow-soft">
              <img src="https://bciawezxmfvosfftvgwa.supabase.co/storage/v1/object/public/web-assets/bgalkaaffah.jpg" alt="Gedung sekolah" loading="lazy" className="h-full w-full object-cover" />
            </div>
          </Reveal>
        </div>
      </section>

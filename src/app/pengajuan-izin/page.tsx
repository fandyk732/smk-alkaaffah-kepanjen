...
export const metadata: Metadata = {
  title: 'Portal Pengajuan Izin | SMK Al Kaaffah Kepanjen',
  description: 'Portal Resmi Layanan Pengajuan Izin Guru dan Karyawan SMK Al Kaaffah Kepanjen.',
};

export default function RekapAbsenPage() {
  const targetUrl = "https://rekap-absen-alkaaffah.vercel.app/pengajuan-izin";
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-slate-100 p-6 sm:p-8 text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-slate-500 leading-relaxed">
            Layanan pengajuan izin, sakit, dan cuti Guru & Karyawan SMK Al Kaaffah Kepanjen.
          </p>
        </div>
